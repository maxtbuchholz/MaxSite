...
const ProjectName = ({appCount, selectedAppName, itemChangedCallBack, selectedAppIndex}) => {
    if(selectedAppName === "Blunder Boats"){
        return (
            <div className="blunderBoatsTextBox projectNameBox" style={{padding: 0, marginRight: 0, marginLeft: 0, margin: 'auto', left: 0, right: 0, minHeight: 0}}>
        ...
        return (
            <div className="projectNameBox" style={{backgroundColor: '#12142400', alignContent: 'center', margin: '10px'}}>
                <div className='tenTunTextBackSide'>
                    <div style={{backgroundColor: '#121424', width: 'calc(100% - 40px)', height: '100%', position: 'absolute', left: 0, right: 0, margin: 'auto', alignContent: 'center'}}/>

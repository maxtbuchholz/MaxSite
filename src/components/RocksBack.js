...
const RocksBack = ({fullBodyTop, rockAnimateValue}) => {
    return(
        <div className="pageMovable" style={{transform: `translate(0, ${fullBodyTop})`, position: 'fixed', width: '100vw', height: 'calc(100vh - 100px)', background: 'transparent'}}>
            ...
            <div className="moveable" style={{transform: `translate(0, calc(${-10 * (1 - 0)}vh + calc(5vh + 100px)))`, position: 'absolute', width: '20%', height: '68vh', background: 'rgb(21,25,45)', right: '30%', borderRadius: '10vw'}}/>
            <div className="moveable" style={{transform: `translate(0, calc(${-10 * (1 - 0)}vh + calc(5vh + 100px)))`, position: 'absolute', width: '20%', height: '68vh', background: 'rgb(21,25,45)', left: '30%', borderRadius: '10vw'}}/>

            <div className="moveable" style={{transform: `translate(0, calc(${-10 * (1 - 0)}vh + calc(14vh + 100px)))`, position: 'absolute', width: '20%', height: '54vh', background: 'rgb(28,38,65)', right: '-10%', borderRadius: '10vw'}}/>
            <div className="moveable" style={{transform: `translate(0, calc(${-10 * (1 - 0)}vh + calc(14vh + 100px)))`, position: 'absolute', width: '20%', height: '54vh', background: 'rgb(28,38,65)', left: '-10%', borderRadius: '10vw'}}/>


            <div className="moveable" style={{transform: `translate(0, calc(${80 * (1 - rockAnimateValue)}vh - calc(50vh + 100px)))`, position: 'absolute', width: '20%', height: '120vh', background: 'rgb(28,44,79)', left: 0, borderRadius: '10vw'}}/>
            <div className="moveable" style={{transform: `translate(0, calc(${80 * (1 - rockAnimateValue)}vh - calc(50vh + 100px)))`, position: 'absolute', width: '20%', height: '120vh', background: 'rgb(28,44,79)', right: 0, borderRadius: '10vw'}}/>

            <div className="moveable" style={{transform: `translate(0, calc(${110 * (1 - rockAnimateValue)}vh - calc(60vh + 100px)))`, position: 'absolute', width: '20%', height: '120vh', background: 'rgb(26,39,70)', left: '20%', borderRadius: '10vw'}}/>
            <div className="moveable" style={{transform: `translate(0, calc(${110 * (1 - rockAnimateValue)}vh - calc(60vh + 100px)))`, position: 'absolute', width: '20%', height: '120vh', background: 'rgb(26,39,70)', right: '20%', borderRadius: '10vw'}}/>

            <div className="moveable" style={{transform: `translate(0, calc(${150 * (1 - rockAnimateValue)}vh - calc(80vh + 100px)))`, position: 'absolute', width: '20%', height: '130vh', background: 'rgb(24,34,61)', right: '40%', borderRadius: '10vw'}}/>
